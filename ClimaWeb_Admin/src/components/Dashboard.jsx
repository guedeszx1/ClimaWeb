    ...
    <div style={{ padding: '40px', backgroundColor: 'var(--bg-primary)', color: 'var(--text-primary)', minHeight: '100vh', fontFamily: 'sans-serif' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #333', paddingBottom: '20px' }}>
        <h2 style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <Cpu size={28} /> Monitoramento da Máquina Virtual (Tempo Real)
        </h2>
        <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
          <span style={{ color: connected ? '#4CAF50' : '#f44336', fontWeight: 'bold' }}>
            <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
              <span style={{ display: 'inline-block', width: '10px', height: '10px', borderRadius: '50%', backgroundColor: connected ? '#4CAF50' : '#f44336' }}></span>
      ...
      <div style={{ marginTop: '40px', height: '350px', background: '#1e1e1e', padding: '20px', borderRadius: '10px' }}>
        <h3 style={{ marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '8px' }}>
          <Zap size={24} color="#8884d8" /> Uso de Processamento (CPU %)
        </h3>
      ...
      <div style={{ marginTop: '40px', height: '350px', background: '#1e1e1e', padding: '20px', borderRadius: '10px' }}>
        <h3 style={{ marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '8px' }}>
          <Brain size={24} color="#82ca9d" /> Consumo de Memória (RAM %)
        </h3>
        <ResponsiveContainer width="99%" height={250}>
          <LineChart data={data}>
            <CartesianGrid strokeDasharray="3 3" stroke='var(--bg-card)' />
